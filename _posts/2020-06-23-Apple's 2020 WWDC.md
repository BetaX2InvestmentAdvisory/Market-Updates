...
1 .	The iPhone being able to act as a car key to BMW 2021 5-series with NFC and in the feature this could be applied to other wireless key cars using Apple’s U1 chip. <br>
...
### Final Takeaways ###
1 .	Apple continues to expand its ecosystem to trap more users into using their products and is attempting to use word of mouth by having user share with each other <br>
2 . Apple may have just set the trend for the future with phones that can unlock cars. If this feature ends up being popular Apple has just taken a big lead in the market as car with wireless key are starting to become a norm <br>
